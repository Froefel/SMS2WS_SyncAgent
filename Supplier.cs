...
{
    public class Supplier : ISyncObject
    {
        private const string _objectName = "supplier";
        ...
        {
            return SupplierRepository.SetSupplierSyncStatus(this.Id, status);
        }
        ...
        {
            const string xsdFileName = "Supplier.xsd";
