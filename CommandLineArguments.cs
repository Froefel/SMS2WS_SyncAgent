...
{
    /// <summary>
    /// This class parses commandline arguments in a more advanced way that the Windows default.
    /// - Support lists, or the same argument specified multiple times. 
    /// - If an argument has commas in it then it will be treated as a list and split on the comma.
    /// - It supports paths with a trailing backslash, ie. –arg:”c:\Users\ginnivanj\My Path\”
    /// - Supports flags
    /// </summary>
    /// CREDITS: http://jake.ginnivan.net/c-sharp-argument-parser
    /// <example_usages>
    /// Argument: –flag
    ...
    class CommandLineArguments
    {
        ...
        /// Base constructor
        /// </summary>
        /// <param name="arguments">string array containing value pairs</param>
        /// <param name="ignoreCase">indicates whether flags are case-sensitive or not (default = false)</param>
        public CommandLineArguments(IEnumerable<string> arguments, bool ignoreCase)
        {
            if (ignoreCase)
            ...
            var argumentSplitter = new Regex(@"^-{1,2}|^/|^\w=|^\w:", RegexOptions.IgnoreCase | RegexOptions.Compiled);
        ...
        public CommandLineArguments(IEnumerable<string> arguments) : this(arguments, false)
        {
        }
        ...
        public Dictionary<string, Collection<string>> Parameters
        {
            get
            {
                return _parameters;
